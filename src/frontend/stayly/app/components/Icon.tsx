...
const paths: Record<IconName, React.ReactNode> = {
  ...
  tree: (
    <>
      <path d="M12 21v-6M7 21h10M12 3 5 14h14L12 3Z" />
      <path d="m12 7-5 8h10l-5-8Z" />
    </>
  ),
  waves: (
  ...
  pool: (
    <>
      <path d="M4 6h16M6 6v6a6 6 0 0 0 12 0V6" />
  ...
  palmtree: (
    <>
      <path d="M12 22v-9" />
      <path d="M12 13c-1-7-7-7-9-4 4-1 6 2 9 4ZM12 13c1-7 7-7 9-4-4-1-6 2-9 4ZM12 13c-5-5-2-9 0-10 2 2 5 5 0 10Z" />
    </>
  ),
  "badge-check": (
    <>
      <path d="m12 3 2.2 2 3-.1.7 2.9 2.5 1.7-1.3 2.7.3 3-2.7 1.3-1.5 2.6-3-.6-3 .6-1.5-2.6-2.7-1.3.3-3-1.3-2.7L6.8 7.8l.7-2.9 3 .1L12 3Z" />
